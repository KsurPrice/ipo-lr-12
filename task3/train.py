# Класс Train — копия из transport/train.py
...
class Train(Vehicle):
    ...
    def __str__(self):
        return f"Поезд {self.vehicle_id}, вагонов: {self.number_of_cars}, грузоподъемность: {self.capacity}т, загружено: {self.current_load}т"
